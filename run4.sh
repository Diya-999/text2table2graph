...
python pkl2df.py --input_folder ./staging/stg_e/dj_news/news_sum_sim/ --output_path ./staging/tmp_t4/news2news.pkl --extract_column_list node1 node2 sim --is_value_str 0 #--query_str 'sim > 0.75'
...
python add_nodes_attrs.py --input_path ./staging/tmp_t4/news_v2.pkl --input_attr_path ./staging/tmp_t4/node_attr_news_ner.pkl --add_cols name tag --output_path ./staging/tmp_t4/news_v2.pkl --add_mode one-to-many  --integrate_approach list --unique_attr_df 1
...
python add_nodes_attrs.py --input_path ./staging/tmp_t4/entity_v2.pkl --input_attr_path ./staging/tmp_t4/node_attr_news_ner.pkl --input_attr_map '{"node":"source","name":"node","tag":"entity_tag"}' --merge_on node source --add_cols entity_tag --output_path ./staging/tmp_t4/entity_v3.pkl
...
### gen json dataset
python df2json.py --input_edge_path ./staging/tmp_t4/entity2entity_v2.pkl ./staging/tmp_t4/news2entity_v2.pkl ./staging/tmp_t4/news2news_v2.pkl --input_node_path ./staging/tmp_t4/news_v2.pkl ./staging/tmp_t4/entity_v3.pkl --output_folder ./json4 --whether_use_node_id 1
