...
### gen json dataset
python df2json.py --input_edge_path ./staging/tmp_t3/entity2entity_v2.pkl ./staging/tmp_t3/news2entity_v2.pkl ./staging/tmp_t3/news2news_v2.pkl --input_node_path ./staging/tmp_t3/news_v2.pkl ./staging/tmp_t3/entity_v2.pkl --output_folder ./json3  --whether_use_node_id 0
