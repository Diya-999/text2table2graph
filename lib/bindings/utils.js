...
function neighbourhoodHighlight(params) {
  ...
  if (params.nodes.length > 0) {
    ...
    for (let nodeId in allNodes) {
      ...
      if (allNodes[nodeId].node_type === "entity"){
        allNodes[nodeId].image = "entity_grey.png";
      }else if(allNodes[nodeId].node_type === "news"){
        allNodes[nodeId].image = "news_grey.png";
      }
      if (allNodes[nodeId].hiddenLabel === undefined) {
    ...
    if (allNodes[selectedNode].node_type === "entity"){
      allNodes[selectedNode].image = "entity.png";
    }else if(allNodes[selectedNode].node_type === "news"){
      allNodes[selectedNode].image = "news.png";
    }
...
function filterHighlightNodesEdges(params) {
  ...
  // if something is selected:
    ...
    for (let i = 0; i < selectedNodes.length; i++) {
      ...
      if (allNodes[selectedNode[i]].node_type === "entity"){
        allNodes[selectedNode[i]].image = "entity.png";
      }else if(allNodes[selectedNode[i]].node_type === "news"){
        allNodes[selectedNode[i]].image = "news.png";
      }
