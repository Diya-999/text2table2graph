...
val_index = df_4_sep.query("df_graph_ind=='after_cut_header'").index[:val_num]
train_index = df_4_sep.query("df_graph_ind=='after_cut_header'").index[val_num:total_train_num]
test_index = df_4_sep.query("df_graph_ind=='after_cut_header'").index[total_train_num:]
